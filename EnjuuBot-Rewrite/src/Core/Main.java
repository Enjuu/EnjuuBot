...
public class Main {
	...
	public static void main (String[] args) {
		...
		commandHandler.commands.put(Config.getString("prefix")+"isonline", new cmdIsOnline());
		commandHandler.commands.put(Config.getString("prefix")+"help", new cmdHelp());
		commandHandler.commands.put(Config.getString("prefix")+"invite", new cmdInvite());
		commandHandler.commands.put(Config.getString("prefix")+"user", new cmdUser());
